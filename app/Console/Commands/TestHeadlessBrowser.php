...
class TestHeadlessBrowser extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'test:headless';
    ...
    public function handle()
    {
        ...
        try {
            ...
            $page->navigate('https://myfin.by/bank/absolutbank/department/565-minsk-pr-nezavisimosti-95')->waitForNavigation();
            $html = $page->getHtml();
            var_dump($html);
            // get page title
